...
<body>
    ...
    <nav class="navbar navbar-light" style="border-bottom: 1px solid rgb(233, 233, 233); background-color: rgb(255, 255, 255);">
        <a class="navbar-brand" style="color:#e63378;">Facturas / Modificar Factura</a>
    ...
    <div class="container-fluid ">
        <div class="container mt-5 mb-5 pt-4">
            <form method="POST" action="modificarFactura.php" class="m-3">
                <p>Diligencia el formulario para buscar la factura que deseas modificar</p>
                <div class="form-row">
                    ...
                    while ($consulta = mysqli_fetch_array($resultados)) {
                        ...
                        <form method="POST" action="modificarFactura.php" class="m-3">
                            <table class="table table-bordered mt-5">
                                ...
                                <tbody>
                                    <tr>
                                        <td><input type="text" value=' . $consulta['idFactura'] . ' name="idFactura" style="width:100%"></td>
            ...
            if (isset($_POST['boton2'])) {
                ...
                $codigo = $_POST['idFactura'];
                $descripcion = $_POST['descripcion'];

                $conexion->query("UPDATE $tabla1 SET descripcion='$descripcion' WHERE idFactura=$codigo");
